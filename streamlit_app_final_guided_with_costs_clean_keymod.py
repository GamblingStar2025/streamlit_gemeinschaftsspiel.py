...
if modus == "🎮 Einzelspieler":
    ...
    gesamt_kosten = anzahl_tipps * preis_pro_tipp
    st.markdown(f"💰 **Gesamtkosten**: {waehrung} {gesamt_kosten:.2f}")

    if st.button("🎯 Tipps generieren", key=f"tipps_generieren_{modus}"):
